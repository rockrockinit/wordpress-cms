...
class TableController extends ControllerBase {
	...
	public function index( $args ) {
		...
		$template = new \WordPress\CMS\Template( 'table.html' );
	...
	public function import( $args ) {
		$template = new \WordPress\CMS\Template( 'import.html' );
	...
	public function calendar( $args ) {
		...
		$template = new \WordPress\CMS\Template( 'calendar.html' );
		$table = $this->get_table( $args['table'] );
	...
	public function timeline( $args ) {
		$table = $this->get_table( $args['table'] );
		$template = new \WordPress\CMS\Template( 'timeline.html' );
