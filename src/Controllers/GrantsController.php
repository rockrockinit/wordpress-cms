...
class GrantsController extends ControllerBase {
	...
	public function __construct( $wpdb ) {
		...
		$this->template = new \WordPress\CMS\Template( 'grants.html' );
	}
	...
	public function save() {
		check_admin_referer( 'cms-grants' );
		$grants = new \WordPress\CMS\DB\Grants();
	...
	public function get_url( $action ) {
		return admin_url( 'admin.php?page=cms&controller=grants&action=' . $action );
	}
}
