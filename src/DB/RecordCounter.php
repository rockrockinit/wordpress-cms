...
class RecordCounter {
	 ...
	 *
	 * @param \WordPress\CMS\DB\Table $table The table to count.
	 */
	public function __construct( \WordPress\CMS\DB\Table $table ) {
		$this->table = $table;
	 ...
	 * stored. All Cms transients start with CMS_SLUG.
	 *
	 * @return string
	 */
	public function transient_name() {
		return CMS_SLUG . '_' . $this->table->get_name() . '_count';
	}
}
