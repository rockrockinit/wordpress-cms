...
class Table {
	 ...
	 *
	 * @param \WordPress\CMS\DB\Database $database The database to which this table belongs.
	 ...
	 * Add a filter.
	 *
	 * @param string|\WordPress\CMS\DB\Column $column Column name or object.
	...
	public function add_filter( $column, $operator, $value, $force = false ) {
		...
		if ( ! $valid_operator ) {
			$msg = __( '"%s" is not a valid value.', 'cms' );
	...
	public function get_title() {
		return \WordPress\CMS\Text::titlecase( $this->get_name() );
	}
	...
	public function export() {
		...
		$filename = $this->get_database()->get_tmp_dir() . uniqid( 'cms_' ) . '.csv';
	 ...
	 * @return \WordPress\CMS\DB\Column|false The column, or false if it's not found.
	 */
	 ...
	 * @return \WordPress\CMS\DB\Column[] Array of this table's columns, keyed by the column names.
	 */
	 ...
	 *
	 * @return \WordPress\CMS\DB\Column[]
	 */
	 ...
	 *
	 * @return \WordPress\CMS\DB\Column|false The PK column or false if there isn't one.
	 */
	 ...
	 *
	 * @return \WordPress\CMS\DB\Database The database object.
	 */
	 ...
	 * @return \WordPress\CMS\DB\Record The updated or inserted record.
