...
use WordPress\CMS\DB\Record;

/**
 * The Change Tracker keeps a log of every data modification made through Cms.
 */
class ChangeTracker {
	 ...
	 *
	 * @var \WordPress\CMS\DB\Record|false
	 */
	 ...
	 *
	 * @param \WordPress\CMS\DB\wpdb $wpdb The global wpdb object.
	 ...
	 *
	 * @global \WordPress\CMS\DB\wpdb $wpdb
	 */
	...
	public static function changesets_name() {
		global $wpdb;
		return $wpdb->prefix . CMS_SLUG . '_changesets';
	}
	...
	public static function changes_name() {
		global $wpdb;
		return $wpdb->prefix . CMS_SLUG . '_changes';
	}
